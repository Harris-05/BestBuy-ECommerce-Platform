...
const productsData = [
  ...
  { name: 'Atomic Habits', price: '$11.98', description: 'No matter your goals, Atomic Habits offers a proven framework for improving--every day. James Clear, one of the world\'s leading experts on habit formation, reveals practical strategies that will teach you exactly how to form good habits, break bad ones, and master the tiny behaviors that lead to remarkable results.', image: 'https://m.media-amazon.com/images/I/81YkqytzS1L._AC_UY218_.jpg', category: 'Books' },
  { name: 'The Psychology of Money', price: '$12.72', description: 'Doing well with money isn’t necessarily about what you know. It’s about how you behave. And behavior is hard to teach, even to really smart people.', image: 'https://m.media-amazon.com/images/I/71TRuY8S-LL._AC_UY218_.jpg', category: 'Books' },
  { name: 'The Silent Patient', price: '$10.43', description: 'The Silent Patient is a shocking psychological thriller of a woman’s act of violence against her husband—and of the therapist obsessed with uncovering her motive.', image: 'https://m.media-amazon.com/images/I/81+2AsT+-PL._AC_UY218_.jpg', category: 'Books' },
];
